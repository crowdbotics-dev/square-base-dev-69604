"""
Django settings for square_base_dev_69604 project.
...
ROOT_URLCONF = 'square_base_dev_69604.urls'
...
WSGI_APPLICATION = 'square_base_dev_69604.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_base_dev_69604 API",
    "DESCRIPTION": "API documentation for square_base_dev_69604 App",
    "VERSION": "v1",
}
